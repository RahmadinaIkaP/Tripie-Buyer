...
class PopularDestinationAdapter(private val onClick: HomeInterface) : RecyclerView.Adapter<PopularDestinationAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(var binding:ItemDestinasiPopularBinding):RecyclerView.ViewHolder(binding.root){
